        ...
        <div class="col-xl-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="row">
                        <p class="fs-14 mr-auto col-lg-6">Smart Lampu adalah sebuah website untuk mengontrol secara
                            manual maupun otomatis lampu rumah yang berbasis Internet of Things</p>
                        <div class="col-lg-6 text-lg-right text-left">
                            <a href="javascript:void(0)" class="btn btn-primary rounded mr-3 mb-sm-0 mb-2"><i
                                    class="fa fa-user mr-3 scale5" aria-hidden="true"></i>Internet of Things</a>
                            <a href="javascript:void(0)" class="btn btn-primary rounded mr-3 mb-sm-0 mb-2"><i
                                    class="fa fa-user mr-3 scale5" aria-hidden="true"></i>Smart Lamp</a>
            ...
            <div class="card-body">
                <div class="basic-form">
                    <form style="text-align: center">
                        <div class="form-group">
                            <span style="font-size: 16pt; font-weight: bold; color:blue;">Tidak ada Kontrol</span>
                        </div>
                    </form>
                </div>
            </div>
